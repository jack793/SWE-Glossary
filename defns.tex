...
description={Definizioni multiple:
\begin{enumerate}
\item (in italiano: quadro di lavoro) Insieme di regole che costruiscono una soluzione coerente [def. Prof. Vardanega]
\item Struttura di supporto su cui un software può essere organizzato e progettato [def. Prof. Cardin]
\end{enumerate}
}
}
